    ...
    <div className="login">
      ...
      <div className="loginWrapper">
        <div className="loginLeft">
          <h3 className="loginLogo">C&M Network</h3>
          <span className="loginDesc">Connect with other people</span>
        </div>
          ...
          >
            <div className="inputHolder">
              ...
              <input
                ...
                id="username"
                type="text"
                className={`loginInput ${formik.errors.username && formik.touched.username && "error"
                  }`}
              />
              { }
            </div>
            <input
              ...
              id="email"
              type="text"
              className={`loginInput ${formik.errors.email && formik.touched.email && "error"
                }`}
            />
            ...
            <input
              ...
              id="password"
              type="password"
              className={`loginInput ${formik.errors.password && formik.touched.password && "error"
                }`}
            />
            <input
              onBlur={formik.handleBlur}
              ...
              type="password"
              id="passwordConfirm"
              className={`loginInput ${formik.errors.passwordConfirm &&
